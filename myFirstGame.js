...
bgImage.src = "_images/background.jpg";
...
heroImage.src = "_images/tumblr_inline_mmd3mmuK9p1qz4rgp.png";
...
monsterImage.src = "_images/511_baby_twitchy.png";
...
projectileImage.src = "_images/smiley.gif";
...
// function making procetile work
function Projectile() {
	this.speed = 25;
...
console.log("Update");
	...
	var render = function () {
		...
		ctx.textAlign = "left";
		ctx.textBaseline = "top";
		ctx.fillText("Timer: " + countDown, 256, 32);
	};
